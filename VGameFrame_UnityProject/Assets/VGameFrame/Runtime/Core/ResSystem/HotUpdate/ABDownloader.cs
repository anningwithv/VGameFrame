...
namespace VGameFramework
{
	public class ABDownloader : MonoBehaviour
	{
        ...
        private readonly List<ABDownloadHandler> _downloads = new List<ABDownloadHandler>();
        private readonly List<ABDownloadHandler> _tostart = new List<ABDownloadHandler>();
        private readonly List<ABDownloadHandler> _progressing = new List<ABDownloadHandler>();
        ...
        public List<ABDownloadHandler> downloads { get { return _downloads; } }
        ...
        public void Stop()
        {
            ...
            foreach (var download in _progressing)
            {
                ...
                _downloads[download.id] = download.Clone() as ABDownloadHandler;
        ...
        {
            var download = new ABDownloadHandler
            {
                id = _downloads.Count,
                url = url,
                name = filename,
        ...
        private void OnFinished(ABDownloadHandler download)
        {
